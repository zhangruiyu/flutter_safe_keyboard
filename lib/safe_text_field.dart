...
import 'package:keyboard/safe_editable_text.dart' as safeText;
import 'package:keyboard/safe_editable_text.dart';
...
/// one of its ancestors to be a [Material] widget. When the [SafeTextField] is
/// tapped an ink splash that paints on the material is triggered, see
/// [ThemeData.splashFactory].
///
/// To integrate the [SafeTextField] into a [Form] with other [FormField] widgets,
...
class SafeTextField extends StatefulWidget {
  ...
  ///
  /// If null, this widget will create its own [safeText.TextEditingController].
  final safeText.TextEditingController controller;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(new DiagnosticsProperty<safeText.TextEditingController>(
...
class _TextFieldState extends State<SafeTextField>
    with AutomaticKeepAliveClientMixin {
  final GlobalKey<safeText.SafeEditableTextState> _editableTextKey =
      new GlobalKey<safeText.SafeEditableTextState>();

  Set<InteractiveInkFeature> _splashes;
  InteractiveInkFeature _currentSplash;

  safeText.TextEditingController _controller;

  safeText.TextEditingController get _effectiveController =>
  ...
  InputDecoration _getEffectiveDecoration() {
    ...
    final String counterText = '${_effectiveController.value.text.runes
  ...
  Widget build(BuildContext context) {
    ...
    final safeText.TextEditingController controller = _effectiveController;
